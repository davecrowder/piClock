...
piClock Provides a program written in Rust to display the current time on a ZeroSeg (<https://thepihut.com/products/zeroseg>) device attached to a <a href="https://www.raspberrypi.org/products/raspberry-pi-zero-w/">Raspberry Pi Zero W</a>.
